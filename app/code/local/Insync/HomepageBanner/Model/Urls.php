...
class Insync_HomepageBanner_Model_Urls extends Mage_Core_Model_Abstract {
    ...
    protected function _getResource() {
            if (is_null($this->_resource)) {
                    $this->_resource = Mage::getResourceModel('homepagebanner/urls');
            }
    ...
    public function saveBitlyUrl($url) {
        ...
        $config = Mage::getStoreConfig('homepagebanner/bitly');
