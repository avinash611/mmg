 ...
 */
class Feet_Homepageblocks_Helper_Image extends Mage_Core_Helper_Abstract {
    ...
    const IMAGE_FOLDER = 'homepageBlocks';
     ...
     *
     * @param Likipe_Homepageblocks_Model_Page $page
     * @param string $attribute
     * @return Likipe_Homepageblocks_Helper_Image
     */
    public function init(Likipe_Homepageblocks_Model_Page $page, $attribute = 'image') {
