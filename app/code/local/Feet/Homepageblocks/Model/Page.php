 ...
 */
class Feet_Homepageblocks_Model_Page extends Mage_Core_Model_Abstract {
    /**
    ...
    public function _construct() {
        $this->_init('homepageblocks/page');
    }
     ...
     *
     * @param int $optionId
     * @return Likipe_Homepageblocks_Model_Page
     */
    ...
    public function getUrl() {
        if ($this->getUrlPath()) {
            return Mage::getUrl('', array(
                        ...
                        '_secure' => false,
                        '_nosid' => true,
                        '_store' => $this->getStoreId() ? $this->getStoreId() : Mage::helper('homepageblocks')->getCurrentFrontendStore()->getId(),
            ));
        }
    ...
    public function getImage() {
        return Mage::helper('homepageblocks/image')->getImageUrl($this->getData('image'));
    }
    ...
    public function getThumbnail() {
        return Mage::helper('homepageblocks/image')->getImageUrl($this->getData('thumbnail'));
    }
     ...
     *
     * @return Likipe_Homepageblocks_Model_Group|false
     */
    ...
    public function getThumbnailWidth() {
        return $this->_convertSize(Mage::getStoreConfig('homepageblocks/images/splash_thumbnail_width'));
    }
    ...
    public function getThumbnailHeight() {
        return $this->_convertSize(Mage::getStoreConfig('homepageblocks/images/splash_thumbnail_height'));
    }
    ...
    public function thumbnailShouldKeepFrame() {
        return Mage::getStoreConfigFlag('homepageblocks/images/splash_thumbnail_keep_frame');
    }
    ...
    public function getImageWidth() {
        return $this->_convertSize(Mage::getStoreConfig('homepageblocks/images/splash_image_width'));
    }
    ...
    public function getImageHeight() {
        return $this->_convertSize(Mage::getStoreConfig('homepageblocks/images/splash_image_height'));
    }
