<?php
class Mapmygenomie_Compare_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Optimage extends  Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function getTabLabel() {
        return Mage::helper('mapmygenomie_compare/optimage')->__('Manage Option Images');
    }
    ...
    public function canShowTab() {
        ...
        $attributes = Mage::helper('mapmygenomie_compare/optimage')->getColorImageAttributes();
    ...
    public function getOptionsCollection()
    {
        if(!$this->_optCollection) {
            ...
            if(!$attribute || !$attribute->getId()) {
                ...
                $this->_optCollection = Mage::getModel('mapmygenomie_compare/optimage')->getOptionCollection($attribute->getId());
            }
        }
