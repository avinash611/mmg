...
class Mapmygenomie_Compare_Helper_Optimage extends Mapmygenomie_Compare_Helper_Data {


     /**
     * config path to transform dropdowns
     */
    const XML_TRANSFORM_PATH   = 'mapmygenomie_compare/settings/transform_dropdowns';

    /**
     * config path to color attributes
     */
    const XML_USE_OPTION_IMAGES_PATH= 'mapmygenomie_compare/settings/use_option_images';
    ...
    protected $_placeholder = '/images/mapmygenomie_compare/no-optimage.gif'; //image placeholder @var string, located in skin directory
