...
Checkout.prototype = {
    ...
    setMethod: function () {
        if ($('login:guest') && $('login:guest').checked) {
            ...
            ga("ec:setAction", "checkout", {step: 2, 'option': 'guest'});
            ga('send', 'pageview', 'checkout/onepage/user-login');
            ga('send', 'event', 'Checkout Process', 'guest', {
            ...
            ga('send', 'pageview', 'checkout/onepage/user-login');
            ga('send', 'event', 'Checkout Process', 'register', {
                hitCallback: function () {
                    // Advance to shipping section.
                }
            });
...
//            }
            ...
            {
                option = 'SHIP TO DIFFERENT ADDRESS';
            }
            ga('ec:setAction', 'checkout', {
                'step': 3,
                'option': option
            });
            ga('send', 'pageview', 'checkout/onepage/billing-info');
            ga('send', 'event', 'Checkout Process', 'Billing Stage', {
                hitCallback: function () {
...
Review.prototype = {
    ...
    save: function () {
        ...
        ga('send', 'pageview', 'checkout/onepage/order-review');
        ga('send', 'event', 'Checkout Process', 'Place Order', {
            hitCallback: function () {
